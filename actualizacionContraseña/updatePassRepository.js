                   ...
                   // console.log("Connected");
                    ...
                    async.waterfall([
                        ...
                        function Insert(callback){
                            request = new Request("UPDATE [dbo].[Usuarios] set Pass = @Pass where Usuario = @Usuario", function(err){  
                                if (err) {
                                        console.log(err);
                                    }  
                                }
                            ...
                            var hash =  crypto.createHash('md5').update(contrasena).digest('hex')
                            request.addParameter('Pass', TYPES.VarChar, hash);  
...
module.exports = updatePassRepository;
